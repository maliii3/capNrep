...
class CulebraTests(CulebraTestCase):
    ...
    def testSomething(self):
        ...
        self.vc.findViewWithTextOrRaise(u'Search letgo').setText(u"ayakkabi")
        self.vc.sleep(_s)
        self.vc.dump(window=-1)
        self.device.touchDip(376.19, 659.05, 0)
        self.vc.sleep(_s)
        self.vc.dump(window=-1)
        self.device.dragDip((204.57, 537.14), (198.86, 160.76), 1000, 20, 0)
        self.vc.sleep(_s)
        self.vc.dump(window=-1)
        self.device.touchDip(207.62, 710.48, 0)
        self.vc.sleep(_s)
