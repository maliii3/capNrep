...
class CulebraTests(CulebraTestCase):
    ...
    def testSomething(self):
        ...
        self.vc.sleep(_s)
        self.vc.dump(window=-1)
        self.vc.findViewWithTextOrRaise(u'SPORTS AND OUTDOORS', root=self.vc.findViewByIdOrRaise('id/no_id/14')).touch()
        self.vc.sleep(_s)
        self.vc.dump(window=-1)
        self.vc.findViewWithTextOrRaise(u'Sports and Outdoors', root=self.vc.findViewByIdOrRaise('id/no_id/11')).touch()
        self.vc.sleep(_s)
