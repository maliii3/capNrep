...
''')
    ...
    def __init__(self, vc, device, serialno, printOperation, scale=1, concertina=False, concertinaConfigFile=None):
        ...
        file = open("/Users/caner/Desktop/capNrep/currentRecord.txt","w") #mali
        file.truncate(0)
        file.close()
    ...
    def printActionAndCode(self,action,code):#mali
        with open("/Users/caner/Desktop/capNrep/currentRecord.txt", "a") as fp:
            fp.write(action + '\n')
            fp.write(code + '\n')
            fp.write('\n')
...
if TKINTER_AVAILABLE:
    ...
    class ViewTree(Tkinter.Frame):
        def __init__(self, parent):
            ...
            self.viewTree.column(0, width=600) #width=20
